...
class BlazeDemo5 extends Simulation {
	...
	object Purchase{
		def methodPurchase ={
			exec(
				...
				.post("/purchase.php")
				.headers(headers_0)
				.formParam("flight", "9696")
				.formParam("price", "200.98")
				.formParam("airline", "Aer Lingus")
				.formParam("fromPort", "Boston")
				.formParam("toPort", "Cairo"))
				.pause(2,5)
		}
...
val scnRefactor= scenario("Fligh Booking" )
	...
	val scnParallel =scenario(("Run parallelly"))
		.exec( Reserve.methodReserve, Purchase.methodPurchase, Confirmation.methodConfirmation)

	setUp(scnRefactor.inject(atOnceUsers(10))).protocols(httpProtocol)



	val scn = scenario("BlazeDemo4")
		.exec(http("BlazeDemo4_0:POST_https://blazedemo.com/reserve.php")
			.post("/reserve.php")
			.headers(headers_0)
			.formParam("fromPort", "Boston")
			.formParam("toPort", "Cairo"))
		.pause(5)
		.exec(http("BlazeDemo4_1:POST_https://blazedemo.com/purchase.php")
			.post("/purchase.php")
			.headers(headers_0)
			.formParam("flight", "9696")
			.formParam("price", "200.98")
			...
			.formParam("toPort", "Cairo"))
		.pause(40)
		.exec(http("BlazeDemo4_2:POST_https://blazedemo.com/confirmation.php")
			.post("/confirmation.php")
			.headers(headers_0)
			.formParam("_token", "")
			.formParam("inputName", "Testing")
