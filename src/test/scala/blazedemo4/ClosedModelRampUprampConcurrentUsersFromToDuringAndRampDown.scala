...
class ClosedModelRampUprampConcurrentUsersFromToDuringAndRampDown extends Simulation {
...
val scnRefactor= scenario("Fligh Booking" )
	...
	setUp(
		...
		(
			...
			rampConcurrentUsers(0).to(20).during(20),
			constantConcurrentUsers(20).during(20),
			rampConcurrentUsers(20).to(0).during(20),


			//constantConcurrentUsers(20).during(20), // 1
