...
import io.gatling.core.Predef.{BlackList, WhiteList, csv, feed, rampUsers, scenario}
...
class RegSimRampUsersPerSecRate1Rate2 extends Simulation {
	...
	setUp(
		scnRefactor.inject(
		//atOnceUsers(10))
			rampUsersPerSec(5).to(20).during(20)
	)
	)
